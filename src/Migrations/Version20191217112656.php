 ...
 */
final class Version20191217112656 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE categorie DROP FOREIGN KEY FK_497DD6341EBAF6CC');
        $this->addSql('ALTER TABLE categorie ADD CONSTRAINT FK_497DD6341EBAF6CC FOREIGN KEY (articles_id) REFERENCES categorie (id)');
    }
}
